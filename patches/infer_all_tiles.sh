...
BASE_DATA_DIR="/scratch/ray25/spun_patch_proc/train_ecm_asia_d-pixel"

# Python environment that has the required packages installed
export PYTHON_ENV="/maps-priv/maps/ray25/miniconda3/envs/btfm/bin/python"
...
TILES_DIR="${BASE_DATA_DIR}/"
OUTPUT_DIR="${BASE_DATA_DIR}/../representations_asia"
